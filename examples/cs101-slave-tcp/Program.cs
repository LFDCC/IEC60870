...
namespace cs101_slave_tcp
{
    public class CS101TestSlave 
    {
        ...
        public static async Task Main (string[] args)
        {
            ...
            // NOTE: new API listens on a TCP port directly (TouchSocket tunnel) instead of the
            // old TcpServerVirtualSerialPort wrapper.
            ...
            Iec101Server slave = new Iec101Server (2404, llParameters);
