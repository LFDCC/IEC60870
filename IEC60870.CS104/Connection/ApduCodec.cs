...
{
    /// <summary>APDU 起始字节 0x68。</summary>
    ...
    #region U-format 功能码与静态模板

    // ── U-format 功能码（放在控制域1，低2位 = 11）──────────────
    /// <summary>STARTDT_ACT 功能码。</summary>
    public const byte StartDtAct = 0x07;
    /// <summary>STARTDT_CON 功能码。</summary>
    public const byte StartDtCon = 0x0B;
    /// <summary>STOPDT_ACT 功能码。</summary>
    public const byte StopDtAct = 0x13;
    /// <summary>STOPDT_CON 功能码。</summary>
    public const byte StopDtCon = 0x23;
    /// <summary>TESTFR_ACT 功能码。</summary>
    public const byte TestFrAct = 0x43;
    /// <summary>TESTFR_CON 功能码。</summary>
